<div class="fixed bottom-0 flex justify-evenly bg-gray-800 pt-1 pb-1 sm:py-4 z-50 w-full lg:hidden">
    ...
    <a href="{{ route('profile.index') }}">
        ...
        @else
            <img class="w-8 h-8 object-cover rounded-full" src="https://ui-avatars.com/api/?name=NO">
        @endif
    </a>
</div>
