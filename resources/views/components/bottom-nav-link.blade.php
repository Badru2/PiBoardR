...
@php
    $classes =
        $active ?? false
            ? 'inline-flex items-center justify-center border-indigo-400 dark:border-indigo-600 text-2xl rounded-full md:text-3xl
            leading-5 text-gray-900 dark:text-gray-100 focus:border-indigo-700 transition duration-150 ease-in-out'
            : 'inline-flex items-center justify-center border-transparent text-2xl font-medium leading-5 text-gray-500 md:text-3xl
